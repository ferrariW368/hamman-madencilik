      ...
      <div>
        ...
        {iletisim && (
          <dl className="mt-6 flex flex-col gap-4 text-sm">
            <div>
              <dt className="text-xs uppercase tracking-[0.08em] text-[color:var(--color-stone-bronze)]">
                Şantiye Adresi
              </dt>
              <dd className="mt-1">{iletisim.santiyeAdresi}</dd>
            </div>
            <div>
              <dt className="text-xs uppercase tracking-[0.08em] text-[color:var(--color-stone-bronze)]">
                Ofis Adresi
              </dt>
              <dd className="mt-1">{iletisim.ofisAdresi}</dd>
            </div>
            <div>
