...
const routes = [
  ...
  localized("en", "/en/events", "Event records will be added with verified dates and media."),
  localized("tr", "/tr/about", "Kurumsal tarihçe ve bilgiler doğrulama sonrasında eklenecektir."),
  localized("en", "/en/about", "Company history and information will be added after verification."),
  localized("tr", "/tr/contact", "Doğrulanmış iletişim kanalları ve form altyapısı henüz yayında değildir."),
  localized("en", "/en/contact", "Verified contact channels and the form system are not yet published."),
